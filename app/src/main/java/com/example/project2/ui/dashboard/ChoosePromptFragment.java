...
public class ChoosePromptFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        personalityButton.setOnClickListener((v)-> Navigation.findNavController(v).navigate(R.id.navigation_loading));

        Button fashionButton = root.findViewById(R.id.fashion_prompt_button);
        fashionButton.setOnClickListener((v)-> Navigation.findNavController(v).navigate(R.id.navigation_loading));

        Button futureButton = root.findViewById(R.id.future_prompt_button);
        futureButton.setOnClickListener((v)-> Navigation.findNavController(v).navigate(R.id.navigation_loading));

        Button recommendedArtistsButton = root.findViewById(R.id.recommended_artists_prompt_button);
        recommendedArtistsButton.setOnClickListener((v)-> Navigation.findNavController(v).navigate(R.id.navigation_loading));

        Button recommendedSongsButton = root.findViewById(R.id.recommended_songs_prompt_button);
        recommendedSongsButton.setOnClickListener((v)-> Navigation.findNavController(v).navigate(R.id.navigation_loading));
